...
export default function TeamLogoUpload({ value, onChange, teamId = 'preview' }: TeamLogoUploadProps) {
    ...
    <div className="space-y-4">
      ...
      <Tabs defaultValue="url" className="w-full">
        ...
        <TabsContent value="url" className="space-y-3">
          <div className="space-y-2">
            <Label htmlFor="logo-url" className="text-sm">Logo URL</Label>
                  ...
                  >
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">
                        {dragActive ? 'Drop team logo here' : 'Click to upload team logo or drag and drop'}
                      </p>
                      <p className="text-xs text-gray-500">
                        PNG, JPG, SVG up to 5MB (Square images work best)
                      </p>
                    </div>
                  </motion.div>
                )}
      ...
      {value && (
        ...
        >
          ...
          <div className="relative h-32 w-32 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg overflow-hidden border mx-auto">
            <img
              src={value}
